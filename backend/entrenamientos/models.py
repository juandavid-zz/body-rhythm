...
class ProgresoEjercicio(models.Model):
    historial = models.ForeignKey(
        HistorialEntrenamiento, on_delete=models.CASCADE,
        related_name='progresos', db_column='historial_id'
    )
    ejercicio = models.ForeignKey(
        Ejercicio, on_delete=models.CASCADE, db_column='ejercicio_id'
    )
    series_realizadas = models.IntegerField(null=True, blank=True)
